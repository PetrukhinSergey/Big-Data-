<h2 align="center">Всем мое почтение!</a></h2>
<h3 align="center">Меня зовут Сергей. Ниже немного о себе и своих навыках</h3>
...
Почти 10 лет в банковской сфере я "варился" в цифрах, таблицах, отчетах и прочих приятных вещах, которые навевают уныние на многих других.   

Участие в проектах и проведение пилотов позволило сформировать навыки самостоятельной работы и нести ответственность за результат.   

Управление собой, открытость, требовательность и объективность пришлось развивать при руководстве коллективом.

Нравится работать с данными, структурировать их, находить взаимосвязи, анализировать результаты, выявлять инсайты и находить причины проблем. Получать моральное удовлетворение от решенной задачи - это неимоверный кайф!<br> 
Изучение SQL и Python открыло новые возможности в аналитике, но...   <br>   
К сожалению, по результатам реорганизация компании новый профиль работы с каждым годом отдаляет меня от аналитики.  Поэтому было принято однозначное решение о смене трудовой деятельности...<br>
...
#Руководство коллективом   #Критическое мышление   #Дисциплина   #SMART   #Адаптивность
